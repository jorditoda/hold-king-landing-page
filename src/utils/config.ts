...
const templateConfig: TemplateConfig = {
  name: "Hold King",
  seo: {
    title: "Download Hold King",
    description: "Hold King",
  },
...
//   appStoreLink: "https://apps.apple.com/us/app/pointer-pointer/id6743094753",
  googlePlayLink:
    "https://play.google.com/store/apps/details?id=com.yapplic.hold_king",
  footer: {
    legalLinks: {
...
//       { href: "/#faq", title: "FAQ" },
  ...
  home: {
    seo: {
      title: "Download Hold King Mobile App",
      description: "Download Hold King Mobile App",
    },
    testimonials: {
      id: "testimonials",
      title: "Testimonials",
...
//         },
  ...
  privacyPolicy: {
    seo: {
      title: "Privacy Policy - Hold King",
      description: "Privacy Policy",
    },
    content: `**Privacy Policy**

This privacy policy applies to the Hold King app (hereby referred to as "Application") for mobile devices that was created by Jordi (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".
...
`,
  ...
  cookiesPolicy: {
    seo: {
      title: "Cookies Policy - Hold King",
...
`,
  ...
  termsAndConditions: {
    seo: {
      title: "Terms and conditions - Hold King",
      description: "Terms and conditions",
    },
    content: `**Terms & Conditions**  

These terms and conditions apply to the Hold King app (hereby referred to as "Application") for mobile devices that was created by Jordi (hereby referred to as "Service Provider") as an Ad Supported service.
